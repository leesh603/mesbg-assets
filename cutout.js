...
const sheets = [
  ...
  { file: 'nb-witchking-fellbeast-v2.png', rows: 1, cols: 1, noRim: true, paintedFile: 'px-nb-witchking-fellbeast-v2.png', names: ['witchking_fellbeast'] },
  { file: 'nb-fellbeasts-v5.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v5.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
  { file: 'nb-fellbeasts-v6.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v6.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
  { file: 'nb-fellbeasts-v7.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v7.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
  { file: 'nb-fellbeasts-v8.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v8.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
  { file: 'nb-fellbeasts-v9.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v9.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
  { file: 'nb-fellbeasts-v10.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v10.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
  { file: 'nb-fellbeasts-v12.png', rows: 1, cols: 3, noRim: true, paintedFile: 'px-nb-fellbeasts-v12.png', names: ['witchking_fellbeast', 'nazgul_fellbeast', 'fellbeast'] },
