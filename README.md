...
| 경로 | 내용 |
|---|---|
| `tokens/` | 유닛·지형 투명 PNG 154종 — **픽셀아트 단순화 버전** (게임에서 바로 쓰는 파일) |
| `tokens_painted/` | 같은 154종의 도색 미니어처 원본 (픽셀화 전 마스터) |
...
| `backgrounds/` | 전장 배경 맵 4종 (미나스 티리스·검은문·헬름 협곡·아몬 술) — 토큰이 도드라지도록 채도 낮춘 탑다운 맵 |
